...
import pickle
from Param_updated_inter import *
...
def test(Model, test_candidate, test_ill, entpair2f_idx, f_emb, batch_size, cuda_num, test_topk):
    ...
    # print(e1_to_e2andscores)
    file_to_write = open(INTERACTION_MODEL_SAVE_PATH.replace("interaction_model_save", "") + DATASET + "_sim_lists.pickle", "wb")
    pickle.dump(e1_to_e2andscores, file_to_write)
