...
MARGIN = 1 # margin
EPOCH_NUM = 20 # train epoch num
ROOT = os.getcwd()
INTERACTION_MODEL_SAVE_PATH = ROOT + "/resources/exp_results/D_W_15K_V1_BERT_INT/0.15_100_1/interaction_model_save"

#load model(base_bert_unit_model) path
BASIC_BERT_UNIT_MODEL_SAVE_PATH = ROOT + "/resources/exp_results/D_W_15K_V1_BERT_INT/0.15_100_1/"
BASIC_BERT_UNIT_MODEL_SAVE_PREFIX = ""
LOAD_BASIC_BERT_UNIT_MODEL_EPOCH_NUM = 1
BASIC_BERT_UNIT_MODEL_OUTPUT_DIM = 300

#load data path
DATA_PATH = ROOT + "/resources/Datasets/sampled/D_W_15K_V1_BERT_INT/0.15_100_1/"
