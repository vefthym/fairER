...
class RDGCN(BasicModel):
    ...
    def init(self):
        ...
        # Export vectors
        # file_to_write = open("local_name_vectors", "wb")
    ...
    def training(self):
        ...
        for i in range(1, self.args.max_epoch + 1):
            ...
            #     flag = self.valid_(self.args.stop_metric, t)
    ...
    def valid_(self, stop_metric, t):
        ...
        hits1_12, mrr_12, TTA_flag = valid("valid", embeds1, embeds2, None, self.args.top_k, self.args.test_threads_num,
