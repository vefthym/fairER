...
class MultiKE(BasicModel):
    ...
    def _generate_literal_vectors(self):
        ...
        # with open("literal_similarity_multiKE/"+self.args.training_data+"/literal_list.pickle", 'wb') as f4:
        #     pickle.dump(self.literal_list, f4)
        # cleaned_KG1 = [v for (_, _, v) in cleaned_attribute_triples_list1]
        # with open("literal_similarity_multiKE/"+self.args.training_data+"/cleaned_KG1.pickle", 'wb') as f1:
        #     pickle.dump(cleaned_KG1, f1)
        ...
        # with open("literal_similarity_multiKE/"+str(self.args.training_data.rsplit('/')[-2])+"/literal_vectors_mat.pickle", 'wb') as f3:
        #     pickle.dump(self.literal_vectors_mat, f3)
        ...
        # with open("literal_similarity_multiKE/"+str(self.args.training_data.rsplit('/')[-2])+"/literal_id_dic.pickle", 'wb') as f3:
        #     pickle.dump(self.literal_id_dic, f3)
        # exit(0)
    ...
    def _generate_attribute_value_vectors(self):
        ...
        # with open("literal_similarity_multiKE/"+str(self.args.training_data.rsplit('/')[-2])+"/values_set_1.pickle", 'wb') as f6:
        #     pickle.dump(values_set_1, f6)

        # with open("literal_similarity_multiKE/"+str(self.args.training_data.rsplit('/')[-2])+"/values_set_2.pickle", 'wb') as f7:
        #     pickle.dump(values_set_2, f7)
