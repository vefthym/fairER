...
def main(dataset, conf):
    ...
    if conf == "original":
        ...
        kg1_mdi = KnowledgeGraph("1", dataset, "multi_directed", "sampled", conf, "RDGCN")
        kg2_mdi = KnowledgeGraph("2", dataset, "multi_directed", "sampled", conf, "RDGCN")

        kg1_mun = KnowledgeGraph("1", dataset, "multi_undirected", "sampled", conf, "RDGCN")
        kg2_mun = KnowledgeGraph("2", dataset, "multi_undirected", "sampled", conf, "RDGCN")
