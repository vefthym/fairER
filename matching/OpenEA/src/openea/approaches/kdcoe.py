...
class KDCoE(BasicModel):
    ...
    def _get_desc_input(self):
        ...
        # desc_uris1.apply(lambda x: print(x))
        # exit(0)
        """
        ...
        # print(names.iloc[e_desc2.iloc[:, 0].values, [1, 2]])
        # exit(0)
        """
        ...
        # print(e_desc_input.iloc[names.iloc[:, 0]])
        # exit(0)
    ...
    def find_new_alignment_desc(self):
        ...
        # print(self.desc_embedding1)
        # print(desc_em1)
        # with open("kdcoe/emb1_D_Y_15K_V2.pickle", 'wb') as f1:
        #     pickle.dump(desc_em1, f1)
        # print(desc_em2)
        # with open("kdcoe/emb2_D_Y_15K_V2.pickle", 'wb') as f2:
        #     pickle.dump(desc_em2, f2)
        # exit(0)
    ...
    def valid_desc(self, stop_metric):
        ...
        dem1, dem2 = self.session.run(fetches=[self.desc_embedding1, self.desc_embedding2],
                                      feed_dict={self.desc1: desc_em1,
                                                 self.desc2: desc_em2})
        hits1_12, mrr_12, TTA_flag = valid(dem1, dem2, None, self.args.top_k,
