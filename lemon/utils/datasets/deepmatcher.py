...
def _deepmatcher_dataset(name, url, dtypes, root=None, download=False):
...
def structured_amazon_google(root=None, download=False):
...
def structured_beer(root=None, download=False):
    return _deepmatcher_dataset(
        "Beer",
...
def structured_dblp_acm(root=None, download=False):
    return _deepmatcher_dataset(
        "DBLP-ACM",
...
def structured_dblp_google_scholar(root=None, download=False):
    return _deepmatcher_dataset(
        "DBLP-GoogleScholar",
...
def structured_fodors_zagat(root=None, download=False):
...
def structured_walmart_amazon(root=None, download=False):
    return _deepmatcher_dataset(
        "Walmart-Amazon",
...
def structured_itunes_amazon(root=None, download=False):
    return _deepmatcher_dataset(
        "iTunes-Amazon",
...
def dirty_dblp_acm(root=None, download=False):
    return _deepmatcher_dataset(
        "Dirty/DBLP-ACM",
...
def dirty_dblp_google_scholar(root=None, download=False):
    return _deepmatcher_dataset(
...
def dirty_walmart_amazon(root=None, download=False):
    return _deepmatcher_dataset(
...
def dirty_itunes_amazon(root=None, download=False):
    return _deepmatcher_dataset(
        "Dirty/iTunes-Amazon",
...
def textual_abt_buy(root=None, download=False):
    return _deepmatcher_dataset(
        "Textual/Abt-Buy",
...
def textual_company(root=None, download=False):
    return _deepmatcher_dataset(
        "Textual/Company",
